...
「たばコン」は、砂を削って🚬を🦊へ届けるスマホ向けブラウザパズルゲームです。Sand Balls風の「掘って流れを作る」遊びを参考にしつつ、車両配送の構図は使わず、🚬を🦊の回収ゾーンへ届けるゲームとして実装しています。ステージは10種類からゲーム開始ごとにランダムで選ばれます。
...
- 危険ゾーンに入った🚬は失われます。黒い🚬は危険ゾーンに近いだけでも失いやすいので注意します。
- リタイアボタンで途中終了できます。
